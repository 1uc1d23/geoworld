...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "GeoWorld — Free Browser Games" },
      {
        name: "description",
        content: "Play Geometry Dash games free in your browser on GeoWorld.",
      },
      {
        property: "og:image",
        content: "/gameplay.png",
      },
      {
        name: "twitter:image",
        content: "/gameplay.png",
      },
      { property: "og:site_name", content: "GeoWorld" },
